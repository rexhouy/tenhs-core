...
*/
  ...
  Link.prototype = {
    ...
    onClick: function onClick(e) {
      ...
      if (this._active) {
        ...
        if (editor._selectedImg) {
          this._createPanel("", $linkelem.attr("href"), editor._selectedImg[0].outerHTML);
        } else {
        ...
        if (editor._selectedImg) {
          // 选中图片
          this._createPanel("", "", editor._selectedImg[0].outerHTML);
        } else if (editor.selection.isSelectionEmpty()) {
          // 选区是空的，未选中内容
          this._createPanel("", "", "");
        } else {
          // 选中内容了
    ...
    // 创建 panel
    _createPanel: function _createPanel(text, link, img) {
      var _this = this;
      ...
      var tpl = "<div>";
      if (!img) {
        tpl += '<input id="' + inputTextId + '" type="text" class="block" value="' + text + '" placeholder="\u94FE\u63A5\u6587\u5B57"/>';
      }
      tpl +=
        '<input id="' +
        inputLinkId +
        ...
        link +
        '" placeholder="http://..."/><div class="w-e-button-container">' +
        '<button id="' +
        btnOkId +
    ...
    _delLink: function _delLink() {
      ...
      if (editor._selectedImg) {
        var selectionText = editor._selectedImg[0].outerHTML;
